...
<div class="container py-4">
  ...
  <form method="post" enctype="multipart/form-data" class="mt-3">
    <div class="mb-2">
      <label class="form-label">Titre<input class="form-control" name="title" required></label>
    </div>
    <div class="mb-2">
      <label class="form-label">Description<textarea class="form-control" name="description"></textarea></label>
    </div>
    <div class="mb-2">
      <label class="form-label">Image produit <input class="form-control" type="file" name="product_image" accept="image/*"></label>
    </div>
    <div class="row">
      <div class="col"><label class="form-label">Prix<input class="form-control" name="price" required></label></div>
      <div class="col"><label class="form-label">Ancien prix<input class="form-control" name="old_price"></label></div>
    </div>
    <div class="row mt-2">
      <div class="col"><label class="form-label">Début<input class="form-control" type="date" name="start_date"></label></div>
      <div class="col"><label class="form-label">Fin<input class="form-control" type="date" name="end_date"></label></div>
    </div>
